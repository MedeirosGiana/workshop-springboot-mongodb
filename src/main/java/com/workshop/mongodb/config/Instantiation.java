...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       postRepository.deleteAll();
        ...
        CommentDTO c1 = new CommentDTO("Boa viajem mano!", sdf.parse("10/02/2023"),new AuthorDTO(alex));
        CommentDTO c2 = new CommentDTO("Aproveite!", sdf.parse("11/02/2023"),new AuthorDTO(bob));
        CommentDTO c3 = new CommentDTO("Tenha um ótimo dia!", sdf.parse("30/03/2023"),new AuthorDTO(alex));
